<%@ Page Title="Contact" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Gaming.aspx.cs" Inherits="HomeOne.Gaming" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="col-md-4">
        ...
        <li>Assassin's Creed III (remasted)</li>
    ...
    <div class="col-md-4">
        ...
        <li>Lego Indiana Jones 2: The Adventure Continues</li>
        <li>Lego Harry Potter: Years 1–4</li>
        <li>Lego Star Wars III: The Clone Wars</li>
        <li>Lego Pirates of the Caribbean: The Video Game</li>
