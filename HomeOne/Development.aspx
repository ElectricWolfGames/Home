<%@ Page Title="Lego" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Development.aspx.cs" Inherits="HomeOne.Development" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="jumbotron">
        <h1>Development</h1>
        <p class="lead">dev stuff</p>
    </div>
